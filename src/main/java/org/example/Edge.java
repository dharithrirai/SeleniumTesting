...
public class Edge {
    ...
    @Before
    public void setUp() {
        System.setProperty("webdriver.edge.driver", "C:/Users/I528719/Downloads/edgedriver_win64/msedgedriver.exe");
    ...
    public void testAddToCart() {
        ...
        String password = "Dhari3rai@18";  // Invalid password
    ...
    public void testPasswordInput() {
        ...
        assertEquals(username, emailElement.getAttribute("value"));
        WebElement passwordElement = driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[2]/div[2]/div[2]/div[2]/div/input"));
        String invalidPassword = "Dahri3rai@18";  // Invalid password (no special characters or numbers)
    ...
    public void testInvalidPasswordErrorMessage() {
        ...
        // Check for appropriate error messages or handling
        WebElement errorMessageElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.className("c-egTsrv cMyUOr\n")));
        String errorMessage = errorMessageElement.getText();
        System.out.println("Invalid: " + errorMessage);
        assertEquals("Passwords must be at least 6 characters.", errorMessage);
        driver.quit();
    }
}
